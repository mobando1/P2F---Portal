...
export class MemStorage implements IStorage {
  ...
  async createSubscription(subscriptionData: InsertSubscription): Promise<Subscription> {
    ...
    const subscription: Subscription = { ...subscriptionData, id, createdAt: new Date() };
  ...
  async createTutor(tutorData: InsertTutor): Promise<Tutor> {
    ...
    const tutor: Tutor = { ...tutorData, id, createdAt: new Date() };
  ...
  async createClass(classData: InsertClass): Promise<Class> {
    ...
    const classItem: Class = { ...classData, id, createdAt: new Date() };
